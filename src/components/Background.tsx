...
const BackgroundContainer = styled('div', {
  ...
  background: 
    ...
    ? 'linear-gradient(to bottom right, #050A1F, #0A1433, #101C40)'
    : 'linear-gradient(to bottom right, #F3EBFF, #E4D7FF, #D6C8FF)',
  // background: 'linear-gradient(to bottom right, #050A1F, #0A1433, #101C40)'
}));
  ...
  useEffect(() => {
    ...
    class Particle {
      ...
      constructor() {
        ...
        const colors = ["rgba(34, 211, 238, 0.7)", "rgba(168, 85, 247, 0.7)", "rgba(236, 72, 153, 0.7)"]
      ...
      {configTheme?.hasBackgroundGradient && (
        <>
          ...
          <canvas ref={canvasRef} style={{
            ...
            pointerEvents: 'none',
            zIndex: 0,
            visibility: theme.palette.mode === 'dark' ? 'visible' : 'hidden',
          }}
          />
          {/* <FooterContainer>
            <FooterContainerSub>
                ...
                <FooterCommunitySub>
                  ...
                  <FooterLinks>
                    ...
                    style={{
                      ...
                      <svg width="20" height="20" viewBox="0 0 20 20" fill="currentColor" fillOpacity="1" xmlns="http://www.w3.org/2000/svg" style={{fill: theme.palette.mode === 'dark' ? 'hsla(0,0%,100%,.54)' : 'hsla(360,100%,0%,.54)', cursor: 'pointer'}}><path d="m4.42 4.73 4.633 6.194-4.662 5.037H5.44l4.082-4.41 3.298 4.41h3.57l-4.893-6.543 4.34-4.689h-1.05l-3.759 4.062-3.037-4.062zm1.543.772h1.64l7.244 9.686h-1.64z"></path></svg>
                    </a>
                  </FooterLinks>
                </FooterCommunitySub>
                </FooterCommunity>
              <FooterText>
                Powered by Marble & Orderly
              </FooterText>
            </FooterContainerSub>
          </FooterContainer> */}
        </>
